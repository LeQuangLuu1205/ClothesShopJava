...
<body>
    <%
    	if (session.getAttribute("acc_username") == null) {
    		response.sendRedirect("/Clothes_Shop/login.jsp");
    	}else{
                ...
                <div class="col-lg-8">
                    <div class="checkout-inner">
                        <div class="billing-address">
                            ...
                            <form class="row" action="paymentServlet" method="post">
                                
                                <div class="col-md-12">
                                    <label>Address</label>
                                    <input class="form-control" type="text" placeholder="Address" name="order_address">
                                </div>
                                ...
                                <div class="col-md-12">
                                	...
                                	<div class="checkout-btn col-md-4">
                                		<input type="hidden" value = "<%=session.getAttribute("acc_username") %>" name="acc_username"/>
                                		<input type="submit" style="background-color:red; border: none; padding:5px 20px; border-radius:5px" value="Confirm order">
                            		</div>
