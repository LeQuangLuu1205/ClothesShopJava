			...
			<nav class="navbar navbar-expand-md bg-dark navbar-dark">
				...
				<div class="collapse navbar-collapse justify-content-between"
					...
					<div class="navbar-nav mr-auto">
						...
						<a href="inputProduct" class="nav-item nav-link active">Add Product</a>
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a href="wishlist.html" class="dropdown-item">Wishlist</a> <a
									href="login.jsp" class="dropdown-item">Login & Register</a> <a
					...
					<div class="navbar-nav ml-auto">
						<div class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle"
								data-toggle="dropdown"> <span><%=session.getAttribute("acc_username")%></span></a>
							<div class="dropdown-menu">
								<a href="loginServlet?command=login" class="dropdown-item">Login</a>
								<a href="#" class="dropdown-item">Register</a> <a
									href="loginServlet?command=logout" class="dropdown-item">Logout</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<form method="post" action ="add">
					...
					<!-- Số lượng sản phẩm -->
					<div class="form-group">
						<label for="quantity">The Num Of Products</label> <input
					...
					<div class="form-group">
						<label>Type</label>
						 ...
						 <c:forEach items = "${listC}" var = "o">
							<option value="${o.getCategory_id()}">${o.getCategory_name()}</option>
						</c:forEach>
						</select>
					</div>
					<!-- Loại sản phẩm -->
					...
					<button type="submit" class="btn btn-primary" value = "Add">Add
						Product</button>
				</form>
			</div>
		</div>
