...
<body>
    ...
    <%
    	...
    	Product product = productDAO.selectById(request.getParameter("product_id"));
    %>
    <div class="nav">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="product-slider-single normal-slider">
                                    <img src="img/<%=product.getProduct_img()%>" alt="Product Image">
                            ...
                            <div class="col-md-7">
                                <div class="product-content">
                                    ...
                                    <div class="price">
                                        <h4>Price:</h4>
                                        <p>$<%=Math.round(product.getProduct_price())%><span>$149</span></p>
                                    </div>
                                    <div class="quantity">
                                        <h4>Quantity:</h4>
                                        <div class="qty">
                                    ...
                                    <div class="action">
                                        <a class="btn" href="cartServlet?command=insert&product_id=<%=product.getProduct_id()%>&cart_id=<%=Integer.parseInt(product.getProduct_id())+1000%>"><i class="fa fa-shopping-cart"></i>Add to Cart</a>
