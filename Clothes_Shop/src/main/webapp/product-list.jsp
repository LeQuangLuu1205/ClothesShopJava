...
<%@page import="com.luu.dao.ProductDAO"%>
            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <a href="loadproduct" class="nav-item nav-link active">Products</a>
                        <a href="loadproduct" class="nav-item nav-link">Product Detail</a>
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img src="img/${p.getProduct_img()}" alt="Product Image">
                                    </a>
                                    <div class="product-action">
                                        <a href="cartServlet?command=insert&product_id=${p.getProduct_id()}&cart_id=${p.getProduct_id()+1000}"><i class="fa fa-cart-plus"></i></a>
                                        <a href="#"><i class="fa fa-heart"></i></a>
                                        <a href="product-detail.jsp?product_id=${p.getProduct_id()}"><i class="fa fa-search"></i></a>
                                    </div>
                                </div>
                                <div class="product-price">
                                    <h3><span>$</span>${p.getProduct_price()}</h3>
